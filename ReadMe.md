...
### Credits
**Video**:  [Youtube](https://www.youtube.com/watch?v=dPmH3G9NQtY&ab_channel=AyushSingh)
**taught by**:  [Youtube](https://www.youtube.com/watch?v=dPmH3G9NQtY&ab_channel=AyushSingh)
...
![](https://blog.zenml.io/assets/posts/customer-satisfaction/trainingandif.png)
...
1. `Ml Flow` Documentation:
    [MLFlow Doc Site for Related](https://docs.zenml.io/v/0.13.2/mlops-stacks/model-deployers)

2. `Zenml` Documentation
   [Zenml Doc Site for Related Work](https://docs.zenml.io/v/0.13.2/mlops-stacks)
    
Other Commands maybe useful for you 😋
   ...
   ```bash
    zenml model-deployer model describe <Your model uuid>
   ```
